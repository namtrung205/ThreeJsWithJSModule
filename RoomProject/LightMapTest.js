...
var map_light_floor = tex_loader.load( '../models/fbx/house/texture/narrow-floorboards1-ue/lightmapF.png' );

// map_light_floor.flipY = false;
...
// var sunLight  = new THREE.HemisphereLight(0xffffff, 0x000000, 0.1);
// scene.add(sunLight);
...
function loadModel() {
		...
		const url = './models/gltf/Test.gltf';
